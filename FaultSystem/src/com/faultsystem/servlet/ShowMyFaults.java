...
public class ShowMyFaults extends HttpServlet{
    ...
    public void process(HttpServletRequest req,HttpServletResponse res)  
        ...
        try{                        
          ...
          System.out.println("ReporterID= "+id);
          ...
          PrintWriter pw = res.getWriter();  
              ...
              al=dao.listAllFaultWithNameByReporterId(d);  
              // table head
              ...
              for(int i=0;i<al.size();i++){  
                  ...
                  pw.println("<td><a href=\"amendfault?faultId="+a+"\" mce_href=\"amendfault?faultId=\""+a+ " onclick=/\"return window.confirm('Delete this record?')/\">Amend this fault</a></td>");  
